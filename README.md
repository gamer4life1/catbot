...
To run the bot for testing, you'll need to install Node (18.x or above), Yarn 3.x ([see here](https://yarnpkg.com/getting-started/install) for install steps) and make a bot on Revolt. Then, do the following:
